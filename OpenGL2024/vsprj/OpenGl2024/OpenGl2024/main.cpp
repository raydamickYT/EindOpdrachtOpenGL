...
int main()
{
	...
	mn.TerrainVAO = terrainGenerator.GeneratePlane("Textures/Heightmap2.png", GL_RGBA, 4, 100.0f, 5.0f, mn.TerrainIndexCount, mn.heightMapID);
	//models
	...
	while (!window.shouldClose())
	{
		...
		//}
		mn.renderer.renderTerrain(mn.terrainProgram, mn.worldInformation, mn.TerrainIndexCount, mn.TerrainVAO);
